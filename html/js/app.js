document.addEventListener("DOMContentLoaded", function () {
    const config = {
        ...
        SuccessEyeIcon: "fa-regular fa-comment", 
        StandardColor: "var(--md-on-surface, white)",
        SuccessColor: "var(--md-success,rgb(145, 53, 137))",
    };
    ...
    function FoundTarget(item) {
        targetEye.className = config.SuccessEyeIcon; // <-- когато имаме target
    ...
    function LeftTarget() {
        targetLabel.textContent = "";
        TargetEyeStyleObject.color = config.StandardColor;
        targetEye.className = config.StandardEyeIcon; // <-- връщаме стандартната икона
